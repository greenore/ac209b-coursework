...
business_attributes <- c("rating","latitude", "longitude", "cuisine",
                         ...
                         "OutdoorSeating", "GoodForKids", "avg_word_count", "state")
...
#### Visualize
```{r}
g1 <- plot_splines(model=fit_gam_spl, term="s(latitude)")
g2 <- plot_splines(model=fit_gam_spl, term="s(longitude)")
g3 <- plot_splines(model=fit_gam_spl, term="s(RestaurantsPriceRange2)")
g4 <- plot_splines(model=fit_gam_spl, term="s(avg_word_count)")
grid.arrange(g1, g2, g3, g4, nrow=2, ncol=2)
```

The plot above shows, that there is some non-linear behavior present in the numerical data. 
...
print(c(acc_gam_intercept, acc_gam_lin, acc_gam_spl))
rm(g1, g2, g3, g4)
```
